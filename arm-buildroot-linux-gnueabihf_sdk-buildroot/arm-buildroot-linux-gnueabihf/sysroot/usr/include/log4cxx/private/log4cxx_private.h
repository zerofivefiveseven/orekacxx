...
#define LOG4CXX_HAS_PTHREAD_SELF 1
#define LOG4CXX_HAS_PTHREAD_SIGMASK 1
#define LOG4CXX_HAS_PTHREAD_SETNAME 1
#define LOG4CXX_HAS_PTHREAD_GETNAME 1
#define LOG4CXX_HAS_THREAD_LOCAL 1
